...
const SidebarHeader = () => {
    ...
    return (
        <>
            <div className="flex justify-between items-center px-3 p-1 bg-[#202C33]">
                    ...
                    <div className="relative">
                        ...
                        <div ref={show} className="flex-flex-col bg-[#17242c] absolute right-1 scale-0 top-5 transition">
                            <ul className="list-unstyled  flex flex-col gap-1 text-white font-semibold py-2 ">
                                <li className="cursor-pointer w-full px-4 py-1 transition-all hover:bg-gray-400 mt-1">Setting</li>
                                <li onClick={() => dispatch(logoutUser())} className="cursor-pointer w-full px-4 py-1 transition-all hover:bg-gray-400 ">Logout</li>
                            </ul>
                        </div>
                    </div>
                </div>
