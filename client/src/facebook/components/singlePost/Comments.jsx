    ...
    <div className="flex ps-3 gap-3 w-[80%]">
      ...
      <div className="flex flex-col w-full">
        <div className="flex  gap-2 w-full items-center">
          <h5 className="text-sm font-bold p-0 m-0">{findUser?.username}</h5>
          <p className="text-[0.7rem] font-semibold text-gray-700">
            {moment(date).fromNow()}
          </p>
          <div className="relative">
            <BsThreeDotsVertical
              className="align-self-end justify-end"
              ...
              <Card className="flex bg-white z-20 py-1 -left-[100px] list-none flex-col gap-1 absolute px-2">
                ...
                {commentUser == user?._id && (
                  <li
                    ...
                    className="flex hover:bg-gray-100 p-1 px-3 cursor-pointer gap-2 items-center"
                  >
                    <CiEdit color="orange" />
                    Edit
                  </li>
