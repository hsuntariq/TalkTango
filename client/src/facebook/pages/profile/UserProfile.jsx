...
const UserProfile = () => {
  ...
  const { myPosts, postLoading } = useSelector((state) => state.auth);
          ...
          <Card>
            <div className="flex flex-col relative">
              <div className="cover-photo">
                <img
                  ...
                  src={
                    findUser?.image
                      ? findUser?.image
                      : "https://www.trendycovers.com/covers/Black_lamborghini_facebook_cover_1394707831.jpg"
                  }
                  alt=""
                />
              </div>
              ...
              <div className="flex absolute gap-10 bottom-10 left-10">
                <Card
                  onClick={handleOpen}
                  className="gap-4 cursor-pointer h-[200px] w-[200px] border p-3 "
                >
                  <img
                    width="100%"
                ...
                <div className="flex flex-col text-3xl self-center capitalize ">
                  <h3 className="text-white font-bold">{findUser?.username}</h3>
                </div>
              </div>
